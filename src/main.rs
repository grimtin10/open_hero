...
use crate::controllers::{ControllerEventType, ControllerManager};
...
fn render_note(assets: &Assets, fret: usize, t: f32) {
    render_texture(&assets.note, lerp(START_X[fret], END_X[fret], t), lerp(305.0, 655.0, t), lerp(0.4, 1.2, t) * 0.629, false);
}
